            ...
            {experiences.map((exp, index) => (
              ...
              >
                ...
                <div className="flex flex-col md:flex-row md:items-start gap-4">
                  {/* Icon */}
                  <div className={`w-16 h-16 bg-linear-to-br ${exp.color} rounded-xl flex items-center justify-center text-3xl shrink-0 group-hover:scale-110 transition-transform`}>
                    {exp.icon}
                  </div>
