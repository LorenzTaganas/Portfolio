...
const Contact = () => {
  return (
    <section id="contact" className="py-20 px-4 bg-linear-to-b from-gray-950 to-black">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-linear-to-br from-gray-900 to-gray-800 rounded-2xl p-8 border border-gray-800 shadow-2xl">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <a 
              ...
              className="group bg-linear-to-br from-purple-500/10 to-transparent p-6 rounded-xl border border-purple-500/20 hover:border-purple-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/20 transform hover:-translate-y-1"
            >
              <div className="text-4xl mb-3 group-hover:scale-110 transition-transform">📧</div>
              <h3 className="text-white font-semibold mb-2 text-lg">Email</h3>
              <p className="text-gray-400 group-hover:text-purple-400 transition-colors text-sm break-all">
            ...
            <a 
              ...
              className="group bg-linear-to-br from-blue-500/10 to-transparent p-6 rounded-xl border border-blue-500/20 hover:border-blue-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/20 transform hover:-translate-y-1"
            >
              <div className="text-4xl mb-3 group-hover:scale-110 transition-transform">💼</div>
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer" 
              className="group bg-linear-to-br from-pink-500/10 to-transparent p-6 rounded-xl border border-pink-500/20 hover:border-pink-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-pink-500/20 transform hover:-translate-y-1"
            >
              <div className="text-4xl mb-3 group-hover:scale-110 transition-transform">🐙</div>
