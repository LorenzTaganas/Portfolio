...
const Projects = () => {
  ...
  return (
    <section id="projects" className="py-24 px-4 sm:px-6 lg:px-8 relative">
      ...
      {selectedProject && (
        <div
          className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto animate-modal-backdrop overscroll-contain"
          role="dialog"
          aria-modal="true"
        ...
        >
          ...
          {/* Modal Container */}
          <div
            className="relative w-full max-w-3xl my-auto rounded-2xl bg-white dark:bg-[#0e1118] border border-slate-200 dark:border-white/[0.14] shadow-2xl shadow-black/80 overflow-hidden z-10 animate-modal-content"
          ...
          >
            ...
            {/* Modal Body */}
            <div className="p-6 sm:p-8 max-h-[75vh] overflow-y-auto overscroll-contain space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-3 px-6 sm:px-8 py-4 border-t border-slate-200 dark:border-white/[0.08] bg-slate-50 dark:bg-[#121620]/80">
              ...
              <div className="flex items-center gap-3 w-full sm:w-auto">
                ...
                <a
                  ...
                  className="w-1/2 sm:w-auto flex items-center justify-center gap-2 px-6 py-2.5 rounded-lg bg-slate-900 text-white dark:bg-white dark:text-black font-mono text-xs font-semibold tracking-wider hover:bg-sky-600 dark:hover:bg-sky-200 transition-all duration-300 shadow-md hover:scale-[1.02]"
                >
