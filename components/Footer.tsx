            ...
            <div className="flex gap-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-12 h-12 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-pink-500 hover:text-[var(--accent-text)] transition-all duration-300 transform hover:scale-110 hover:shadow-lg text-[var(--text-secondary)]"
