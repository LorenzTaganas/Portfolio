...
const Hero = () => {
  return (
    <div id="home" className="relative pb-20 pt-10">
      ...
      <div className="absolute inset-0 bg-linear-to-br from-purple-900/20 via-black to-blue-900/20 animate-pulse"></div>
      
      <div className="relative h-screen w-full flex items-center justify-center">
        <div className="text-center">
          {/* Animated greeting */}
          <div className="mb-4 animate-fade-in">
            <span className="text-purple-400 text-lg md:text-xl">👋 Welcome to my portfolio</span>
          </div>
          ...
          <p className="text-lg text-gray-400 max-w-2xl mx-auto mb-8 px-4 leading-relaxed">
          ...
          <div className="flex gap-4 justify-center animate-fade-in flex-wrap px-4">
            ...
            <a 
              href="/resume.pdf" 
              download
              className="group px-8 py-4 border-2 border-cyan-500 text-cyan-400 rounded-lg hover:bg-cyan-500 hover:text-white transition-all duration-300 transform hover:scale-105"
            >
              <span className="flex items-center gap-2">
                📄 Resume
              </span>
